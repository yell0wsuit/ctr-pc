...
namespace CutTheRope.GameMain
{
    internal sealed class PollenDrawer : BaseElement
    {
        ...
        public void AddPollenAtparentIndex(Vector v, int pi)
        {
            ...
            Quad3D qv = Quad3D.MakeQuad3D((double)(v.XAxis - (num6 / 2)), (double)(v.YAxis - (num7 / 2)), 0.0, num6, num7);
        ...
        public void FillWithPolenFromPathIndexToPathIndexGrab(int p1, int p2, Grab g)
        {
            ...
            for (int i = 0; i <= num2; i++)
            {
                ...
                v4.XAxis += RND_RANGE((int)RTPD(-2.0), (int)RTPD(2.0));
                v4.YAxis += RND_RANGE((int)RTPD(-2.0), (int)RTPD(2.0));
