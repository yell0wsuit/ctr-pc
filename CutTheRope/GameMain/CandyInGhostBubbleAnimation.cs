...
namespace CutTheRope.GameMain
{
    internal sealed class CandyInGhostBubbleAnimation : Animation
    {
        ...
        public void AddSupportingCloudsTimelines()
        {
            ...
            timeline.AddKeyFrame(KeyFrame.MakePos(backCloud.x + 1f, backCloud.y + 1f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline2.AddKeyFrame(KeyFrame.MakePos(backCloud2.x + 1f, backCloud2.y + 1f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline3.AddKeyFrame(KeyFrame.MakePos(backCloud3.x + 1f, backCloud3.y + 1f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline4.AddKeyFrame(KeyFrame.MakePos(image.x - 1f, image.y + 1f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline5.AddKeyFrame(KeyFrame.MakePos(image2.x + 1f, image2.y - 1f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
