...
namespace CutTheRope.GameMain
{
    internal sealed class CandyInGhostBubbleAnimation : Animation
    {
        ...
        public void AddSupportingCloudsTimelines()
        {
            ...
            timeline2.AddKeyFrame(KeyFrame.MakeScale(0.93f, 0.93f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline2.AddKeyFrame(KeyFrame.MakePos((int)(backCloud2.x + 1f), (int)(backCloud2.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            timeline2.AddKeyFrame(KeyFrame.MakePos((int)backCloud2.x, (int)backCloud2.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.4f));
            timeline2.AddKeyFrame(KeyFrame.MakePos((int)(backCloud2.x - 1f), (int)(backCloud2.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.4f));
            timeline2.AddKeyFrame(KeyFrame.MakePos((int)backCloud2.x, (int)backCloud2.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.4f));
            timeline2.AddKeyFrame(KeyFrame.MakePos((int)(backCloud2.x + 1f), (int)(backCloud2.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.4f));
            ...
            timeline3.AddKeyFrame(KeyFrame.MakeScale(0.33f, 0.33f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline3.AddKeyFrame(KeyFrame.MakePos((int)(backCloud3.x + 1f), (int)(backCloud3.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            timeline3.AddKeyFrame(KeyFrame.MakePos((int)backCloud3.x, (int)backCloud3.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.43f));
            timeline3.AddKeyFrame(KeyFrame.MakePos((int)(backCloud3.x - 1f), (int)(backCloud3.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.43f));
            timeline3.AddKeyFrame(KeyFrame.MakePos((int)backCloud3.x, (int)backCloud3.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.43f));
            timeline3.AddKeyFrame(KeyFrame.MakePos((int)(backCloud3.x + 1f), (int)(backCloud3.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.43f));
            ...
            timeline4.AddKeyFrame(KeyFrame.MakeScale(0.6f, 0.6f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline4.AddKeyFrame(KeyFrame.MakePos((int)(image.x - 1f), (int)(image.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            timeline4.AddKeyFrame(KeyFrame.MakePos((int)image.x, (int)image.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.42f));
            timeline4.AddKeyFrame(KeyFrame.MakePos((int)(image.x + 1f), (int)(image.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.42f));
            timeline4.AddKeyFrame(KeyFrame.MakePos((int)image.x, (int)image.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.42f));
            timeline4.AddKeyFrame(KeyFrame.MakePos((int)(image.x - 1f), (int)(image.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.42f));
            ...
            timeline5.AddKeyFrame(KeyFrame.MakeScale(0.93f, 0.93f, KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            ...
            timeline5.AddKeyFrame(KeyFrame.MakePos((int)(image2.x + 1f), (int)(image2.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0));
            timeline5.AddKeyFrame(KeyFrame.MakePos((int)image2.x, (int)image2.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.47f));
            timeline5.AddKeyFrame(KeyFrame.MakePos((int)(image2.x - 1f), (int)(image2.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.47f));
            timeline5.AddKeyFrame(KeyFrame.MakePos((int)image2.x, (int)image2.y, KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.47f));
            timeline5.AddKeyFrame(KeyFrame.MakePos((int)(image2.x + 1f), (int)(image2.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.47f));
