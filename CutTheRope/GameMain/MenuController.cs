...
namespace CutTheRope.GameMain
{
    internal sealed class MenuController : ViewController, IButtonDelegation, IMovieMgrDelegate, IScrollableContainerProtocol, ITimelineDelegate
    {
        ...
        public static Button CreateButton2WithImageQuad1Quad2IDDelegate(string resourceName, int q1, int q2, ButtonId bid, IButtonDelegation d)
        {
            ...
            image.x -= relativeQuadOffset.XAxis;
            image.y -= relativeQuadOffset.YAxis;
            Button button = new Button().InitWithUpElementDownElementandID(up, image, bid);
            button.delegateButtonDelegate = d;
            return button;
        }
        ...
        public static Button CreateButtonWithImageQuad1Quad2IDDelegate(string resourceName, int q1, int q2, int bid, IButtonDelegation d)
        {
            ...
            button.delegateButtonDelegate = d;
            CTRTexture2D texture = Application.GetTexture(resourceName);
            button.ForceTouchRect(MakeRectangle(texture.quadOffsets[q1].XAxis, texture.quadOffsets[q1].YAxis, texture.quadRects[q1].w, texture.quadRects[q1].h));
            return button;
        }
        ...
        public static Image CreateAudioElementForQuadwithCrosspressediconOffset(int q, bool b, bool p, Vector offset)
        {
            ...
            image2.x += offset.XAxis;
            image2.y += offset.YAxis;
            _ = image.AddChild(image2);
            if (b)
            {
        ...
        public void CreateMainMenu()
        {
            ...
            if (flag)
            {
                ...
                button.x -= texture.preCutSize.XAxis;
                button.y -= texture.preCutSize.YAxis;
                ...
                button2.x -= texture.preCutSize.XAxis;
                button2.y -= texture.preCutSize.YAxis;
                if (flag)
                {
                ...
                image.x -= texture.preCutSize.XAxis;
                image.y -= texture.preCutSize.YAxis;
        ...
        {
            return Image.GetQuadSize(Resources.Img.MenuPackSelection, 4).XAxis + (Image.GetQuadOffset(Resources.Img.MenuPackSelection, 4).XAxis * 2f);
        }
        ...
        public void CreatePackSelect()
        {
            ...
            BaseElement baseElement2 = new()
            {
                width = (int)texture.preCutSize.XAxis,
                height = (int)texture.preCutSize.YAxis
            };
        ...
        public void CreateLevelSelect()
        {
            ...
            float x = (SCREEN_WIDTH / 2f) - quadSize.XAxis;
            image.x = x;
            ...
            image3.x = Image.GetQuadOffset(Resources.Img.MenuLoading, 0).XAxis;
            image3.y = 80f;
            image4.x = Image.GetQuadOffset(Resources.Img.MenuLoading, 1).XAxis;
            image4.y = 80f;
        ...
        public override void Update(float delta)
        {
            ...
            if (activeViewID == 3 && aboutAutoScroll)
            {
                ...
                scroll.YAxis += 0.5f;
                scroll.YAxis = FIT_TO_BOUNDARIES(scroll.YAxis, 0.0, maxScroll.YAxis);
