...
{
    /// <summary>
    /// Lightweight particle emitter used by <see cref="EasterFingerTrace"/> for the CTR2 Easter trail.
    /// </summary>
    internal sealed class EasterTraceParticles : FrameworkTypes
    {
        ...
        /// <summary>
        /// Creates a newly emitted Easter particle from the current emitter state.
        /// </summary>
        ...
        /// <summary>
        /// Stores the state of one live Easter particle.
        /// </summary>
