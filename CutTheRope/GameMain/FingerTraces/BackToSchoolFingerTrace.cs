...
namespace CutTheRope.GameMain.FingerTraces
{
    ...
    /// </summary>
    internal sealed class BackToSchoolFingerTrace : FingerTrace
    {
        ...
        /// <summary>The school-themed particle emitter.</summary>
        private readonly BackToSchoolTraceParticles particles = new();
        ...
        /// <summary>Draws the sampled back-to-school ribbon as a colored triangle strip.</summary>
        ...
        /// <summary>Returns the back-to-school ribbon gradient color for the normalized position along the strip.</summary>
