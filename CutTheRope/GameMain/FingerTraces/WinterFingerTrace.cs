...
namespace CutTheRope.GameMain.FingerTraces
{
    ...
    internal sealed class WinterFingerTrace : FingerTrace
    {
        ...
        /// <summary>The winter particle emitter.</summary>
        ...
        /// <summary>
        /// Draws the sampled winter ribbon as a colored triangle strip.
        /// </summary>
        ...
        /// <summary>
        /// Returns the winter ribbon gradient color for the normalized position along the strip.
        /// </summary>
