...
{
    /// <summary>
    /// Lightweight particle emitter used by <see cref="AlphabetFingerTrace"/> for the CTR2 alphabet trail.
    /// </summary>
    internal sealed class AlphabetTraceParticles : FrameworkTypes
    {
        /// <summary>
        /// The maximum number of live particles the emitter keeps at once.
        /// </summary>
        ...
        /// <summary>
        /// The number of particle quads available in the atlas.
        /// </summary>
        private const int QuadCount = 5;

        /// <summary>
        /// The spawn-position jitter applied around the emitter.
        /// </summary>
        private const float PositionVariance = 5f;

        /// <summary>
        /// The inward radial acceleration applied after spawn.
        /// </summary>
        private const float RadialAcceleration = -200f;

        /// <summary>
        /// The live particle list in age order.
        /// </summary>
        private readonly List<Particle> particles = [];

        /// <summary>
        /// The current emitter position used for newly spawned particles.
        /// </summary>
        private Vector emitterPosition;

        /// <summary>
        /// The center emission rotation in degrees.
        /// </summary>
        private float emitterRotation;

        /// <summary>
        /// The requested particle emission rate in particles per second.
        /// </summary>
        private float emissionRate;

        /// <summary>
        /// The accumulated time toward the next emitted particle.
        /// </summary>
        ...
        /// <summary>
        /// Creates a newly emitted alphabet particle from the current emitter state.
        /// </summary>
        ...
        /// <summary>
        /// Stores the state of one live alphabet particle.
        /// </summary>
