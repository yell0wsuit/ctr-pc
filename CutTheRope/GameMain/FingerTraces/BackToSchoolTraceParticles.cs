...
{
    /// <summary>
    /// Lightweight particle emitter used by <see cref="BackToSchoolFingerTrace"/> for the CTR2 back-to-school trail.
    /// </summary>
    internal sealed class BackToSchoolTraceParticles : FrameworkTypes
    {
        ...
        private const int FirstQuad = 39;
        ...
        /// <summary>
        /// Creates a newly emitted back-to-school particle from the current emitter state.
        /// </summary>
        ...
        /// <summary>
        /// Stores the state of one live back-to-school particle.
        /// </summary>
