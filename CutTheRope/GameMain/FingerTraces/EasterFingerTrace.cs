...
{
    /// <summary>
    /// CTR2-style Easter finger trace with a cyan ribbon, glow overlay, and butterfly particles.
    /// </summary>
    internal sealed class EasterFingerTrace : FingerTrace
    {
        ...
        /// <summary>The Easter particle emitter.</summary>
        private readonly EasterTraceParticles particles = new();
        ...
        /// <summary>Draws the sampled Easter ribbon as a colored triangle strip.</summary>
        ...
        /// <summary>
        /// Pastel cyan (0.14118, 0.81961, 0.87451) fading to white by t=0.35.
        /// </summary>
        /// <summary>Returns the Easter ribbon gradient color for the normalized position along the strip.</summary>
