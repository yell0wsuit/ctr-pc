    ...
    internal sealed class Star : CTRGameObject, IConveyorItem, IConveyorSizeProvider, IConveyorPaddingProvider
    {
        ...
        public void CreateAnimations()
        {
            if (timeout > 0)
            {
                ...
                timeline2.AddKeyFrame(KeyFrame.MakeScale(0, 0, KeyFrame.TransitionType.FRAME_TRANSITION_LINEAR, 0.25));
            ...
            bobTime = (float)(RND_RANGE(0, 20) / 10);
            ...
            Timeline.UpdateTimeline(animation.GetTimeline(0), (float)(RND_RANGE(0, 20) / 10));
