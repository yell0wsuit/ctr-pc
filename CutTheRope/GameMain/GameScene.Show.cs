    ...
    internal sealed partial class GameScene
    {
        ...
        public void StartCamera()
        {
            if (mapWidth > SCREEN_WIDTH || mapHeight > SCREEN_HEIGHT)
            {
                ...
                {
                    if (constraintedPoint.pos.XAxis > mapWidth / 2.0)
                    {
                        num = 0f;
                        num2 = 0f;
                    }
                ...
                else if (constraintedPoint.pos.YAxis > mapHeight / 2.0)
                {
                    num = 0f;
                    num2 = 0f;
                }
                ...
                double num6 = (double)(constraintedPoint.pos.XAxis - (SCREEN_WIDTH / 2f));
                float num3 = constraintedPoint.pos.YAxis - (SCREEN_HEIGHT / 2f);
