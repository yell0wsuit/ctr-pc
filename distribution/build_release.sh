...
dotnet publish ../CutTheRope/CutTheRope.csproj -c Release -r osx-arm64 -f net10.0 -p:VersionPrefix="$VERSION" -p:VersionSuffix= -o ../CutTheRope/bin/Publish/osx-arm64
