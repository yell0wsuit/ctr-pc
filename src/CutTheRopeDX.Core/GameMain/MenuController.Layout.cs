...
namespace CutTheRopeDX.GameMain
{
    ...
    internal sealed partial class MenuController
    {
        ...
        {
            // The main menu's logo hangs from the top edge and its button column from the bottom,
            // so the composition keeps both ends of the screen whatever shape the viewport takes.
            SpanWidth(mainMenuButtons, visible);
