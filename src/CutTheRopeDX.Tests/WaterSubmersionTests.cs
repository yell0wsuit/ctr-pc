...
namespace CutTheRopeDX.Tests
{
    ...
    {
        [Fact]
        public void IsSubmergedTrueWhenBelowSurfaceInsideWaterColumn()
        {
            Assert.True(WaterSubmersion.IsSubmerged(100f, 130f, 50f, 120f, 100f, 20f));
        }

        [Fact]
        public void IsSubmergedFalseWhenAboveOrAtSurface()
        {
        ...
        [Fact]
        public void IsSubmergedFalseWhenOutsideWaterColumn()
        {
        ...
        [Fact]
        public void IsSubmergedTrueOnInclusiveHorizontalBoundaries()
        {
