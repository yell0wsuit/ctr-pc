namespace CutTheRopeDX.GameMain
{
    ...
    /// is not held by the active mouse, and physically intersects the rocket. <paramref name="intersects"/>
    /// is precomputed by the caller (<c>GameObject.ObjectsIntersectRotatedWithUnrotated</c>).
    /// </summary>
